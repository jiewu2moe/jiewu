...
Page({
   ...
   */
  data: {
    useKeyboardFlag:true,   //键盘或者语音
    keyboardInputValue: '', //input初始值
    sendMoreMsgFlag: false, //显示图片选择
    chooseFiles:[],     //保存选择图片数组
    deleteIndex:-1,       //删除的图片序号
    currentAudio:""       //保存当前正播放的录音
  },
...
//预览图片
  ...
  bindCommentInput: function (event) {
    ...
    //return value.replace(/关键字/g,'*')       屏蔽和谐关键字
  ...
  submitComment: function (event) {
    ...
    var newData = {
      username: "CCCccc_",
      avatar: "/images/avatar/CCCccc_.jpg",
